...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/config/workspace/env' "
                ...
                "-I/config/workspace/env/include' "
                "'CPP=/config/workspace/env/bin/aarch64-conda_cos7-linux-gnu-cpp' "
 ...
 'LIBPL':
     '/config/workspace/env/lib/python3.8/config-3.8-aarch64-linux-gnu',
 ...
 'OPENSSL_INCLUDES': '-I/config/workspace/env/include',
 'OPENSSL_LDFLAGS': '-L/config/workspace/env/lib',
